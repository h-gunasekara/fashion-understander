...
## Methodology
This analysis identifies verified style combinations that appear multiple times across Shopbop's knitwear catalog.
Each pattern is documented with at least 3 product examples and represents a genuine trend rather than 
one-off combinations. Patterns are ranked by frequency and price positioning.
